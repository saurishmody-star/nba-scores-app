  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col">
      ...
      <header className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white shadow-xl border-b border-slate-700">
        <div className="max-w-full px-6 py-5">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">NBA Live Scores</h1>
            ...
            <button
              onClick={refresh}
              className="flex items-center gap-2 px-5 py-2.5 bg-white/10 hover:bg-white/20 rounded-xl transition-all text-sm font-medium border border-white/10 hover:border-white/20"
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-96 bg-white border-r border-gray-200 overflow-y-auto shadow-sm">
          <div className="p-5">
            <h2 className="text-xl font-bold text-gray-900 mb-5 px-1">
          ...
          {selectedGame ? (
            ...
            <div className="flex items-center justify-center h-full p-8">
              <div className="text-center max-w-md">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl flex items-center justify-center shadow-sm">
